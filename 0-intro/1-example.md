...
$$\begin{aligned} \textbf{x} & \equiv (x_1, \cdots, x_i, \cdots, x_N)^T, \quad x_i \in [0, 1] \\ \textbf{t} & \equiv (t_1, \cdots, t_i, \cdots, t_N)^T, \quad t_i = \sin(2\pi x_i) + N(\mu, \sigma^2)\end{aligned}$$
...
![](https://drive.google.com/uc?id=174y_Vy7ZA0dBMhu8qeWgF_MU17cYM6Yq)
...
![](https://drive.google.com/uc?id=1lwuWg5WUbJap4ZPOH7twAENyGUhsDHb0)

```python
# M=9 | rms_train: 0.0872 rms_test: 19.2855
```

![](https://drive.google.com/uc?id=1ll2uARbNT4zXlr9q9uco3bYae-aGsJJR)
...
![](https://drive.google.com/uc?id=1DiQLWSPY08FlB51AKP69KzIx7tfsYw-K)
